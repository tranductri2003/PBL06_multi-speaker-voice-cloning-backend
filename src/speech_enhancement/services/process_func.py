...
def audio_files_to_numpy(raw_audio, sample_rate, frame_length, hop_length_frame, min_duration):
    total_duration = librosa.get_duration(y=raw_audio, sr=sample_rate)
    if total_duration < min_duration:
        raise ValueError("Audio is shorter than the minimum duration required.")
    return audio_to_audio_frame_stack(raw_audio, frame_length, hop_length_frame)
